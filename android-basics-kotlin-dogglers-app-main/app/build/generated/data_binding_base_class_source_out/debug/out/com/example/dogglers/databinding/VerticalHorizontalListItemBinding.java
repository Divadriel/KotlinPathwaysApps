...
public final class VerticalHorizontalListItemBinding implements ViewBinding {
  ...
  private VerticalHorizontalListItemBinding(@NonNull MaterialCardView rootView,
      @NonNull ImageView imageViewItem, @NonNull TextView tvAgeItem,
      @NonNull TextView tvHobbiesItem, @NonNull TextView tvNameItem) {
  ...
  public static VerticalHorizontalListItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new VerticalHorizontalListItemBinding((MaterialCardView) rootView, imageViewItem,
          tvAgeItem, tvHobbiesItem, tvNameItem);
    }
